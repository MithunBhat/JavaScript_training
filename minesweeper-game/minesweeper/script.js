document.addEventListener('DOMContentLoaded', () => {
	const easyScore = document.querySelector('#easy');
	const mediumScore = document.querySelector('#medium');
	const hardScore = document.querySelector('#hard');
	...
	function displayScore(dif, ele) {
			let localScore = JSON.parse(localStorage.getItem('localObj'));
			console.log(localScore)
			let arr = localScore[dif].sort(function(a,b) {return a-b;}).slice(0,10);
			for (let item of arr) 
			{
